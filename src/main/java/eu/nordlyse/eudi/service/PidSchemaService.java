    ...
    public List<SchemaField> fields() {
        return List.of(
                ...
                field("issuing_jurisdiction", "issuing_jurisdiction", "issuing_jurisdiction", "optional", "string",
                        ...
                        "CIR 2024/2977"),
                field("location_status", "status (SD-JWT VC mechanism)", "(MSO revocation in mdoc)", "optional", "uri",
                        "Location of validity status information. Encoded via SD-JWT VC status / mdoc MSO rather than a PID claim.",
                        "CIR 2024/2977 (historical) / PID Rulebook"),
